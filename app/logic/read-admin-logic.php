...
?>
<div class="p-5 rounded-lg my-3 flex justify-between items-center w-full bg-blue-200">
    <h2 class="text-lg text-blue-600"><?= $blog["title"] ?></h2>
    <div class="space-x-3">
        <button data-id="<?= $blog["id"] ?>" class="delete-blog cursor-pointer">
        ...
        <a class="update-blog" href="./edit/<?= $blog["id"] ?>">
